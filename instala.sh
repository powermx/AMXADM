...
echo -e "\033[1;36mwget https://raw.githubusercontent.com/powermx/AndroidMexicoADM/master/Install/apt-source.sh && chmod 777 ./* && ./apt-*"
echo -e "${cor[5]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -ne "\033[0m"
exit 1
}
...
wget -O trans https://raw.githubusercontent.com/powermx/AndroidMexicoADM/master/Install/trans -o /dev/null 2>&1
...
echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -ne "${cor[4]}"
wget -O lista https://raw.githubusercontent.com/powermx/AndroidMexicoADM/master/lista -o /dev/null
valid_fun
